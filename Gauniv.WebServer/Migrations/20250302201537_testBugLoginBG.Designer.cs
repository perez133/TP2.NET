...
namespace Gauniv.WebServer.Migrations
{
    ...
    [Migration("20250302201537_testBugLoginBG")]
    partial class testBugLoginBG
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gauniv.WebServer.Data.UserFriend", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Gauniv.WebServer.Data.Game", b =>
                {
                    b.HasOne("Gauniv.WebServer.Data.User", null)
                        .WithMany("JeuxAchetes")
                        .HasForeignKey("UserId");
                });

            modelBuilder.Entity("Gauniv.WebServer.Data.UserFriend", b =>
                {
                    b.HasOne("Gauniv.WebServer.Data.User", "Friend")
                        .WithMany("FriendOf")
